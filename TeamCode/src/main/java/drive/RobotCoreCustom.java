...
public class RobotCoreCustom {
    ...
    public Servo gripper, servoLeft, servoRight;
    ...
    public void setDiffPos(double[] pos) {
        ...
        double tilt = pos[0];   // [-1, 1] range preferred
        double rotate = pos[1]; // [-1, 1] range preferred

        // Base centered value
        double base = 0.5;

        // Calculate raw servo positions
        double leftPos = base + tilt + rotate;
        double rightPos = base + tilt - rotate;
