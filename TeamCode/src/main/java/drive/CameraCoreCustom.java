...
public class CameraCoreCustom {
    ...
    public static double calculateRectangleAngle(double[][] points) {
        ...
        if (points.length != 4) {
            throw new IllegalArgumentException("Exactly 4 points are required to define a rectangle, num points is: ".concat(strPoints));
        }

        // Assume the rectangle's diagonal determines the long axis
