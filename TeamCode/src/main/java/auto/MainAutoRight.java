...
@Autonomous(name = "MainAutoRight V2", group = "!", preselectTeleOp = "TerraBiteDrive V1")
public class MainAutoRight extends OpMode {
    ...
    // Define poses
    private final Pose startPose = new Pose(8.75, 65.75, Math.toRadians(0));
    ...
    private final Pose pose2 = new Pose(53.1, 29.5, Math.toRadians(315));
    private final Pose pose3 = new Pose(21.1, 29.5, Math.toRadians(270));
    private final Pose pose4 = new Pose(56.8, 20, Math.toRadians(270)); //Heavy Curve out left
    ...
    int[] targetArmPos = {0, 0};
    int[] armDownPos = {20, 70};
    int[] armUpPos = {2600, 580};
